...
Checkout the [⚡ Block Explorer](https://rinkeby.fuel.sh/network)

Use the one-click [💻 Wallet SDK Example](/v1.0.0/Getting%20Started/One-Click%20Start.html)

We are always available to...

[![Community](/assets/images/discord.svg)](https://discord.gg/xfpK4Pe)
