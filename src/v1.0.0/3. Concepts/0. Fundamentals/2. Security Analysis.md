...
1. The system must be more scalable than the main chain. Combining this and the decentralized and trust-minimized properties, the system must have a higher throughput while being trust-minimized and as decentralized as the main chain.
