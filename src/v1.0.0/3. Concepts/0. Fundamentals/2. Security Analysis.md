...
In summary, if using NFTs is critical, then ZK rollups are the better choice. For everything else, UTXO-based optimistic rollups are superior.

Rollup Mythbusting
---

TODO leader selection PoS
