...
TODO immediately withdraw fungible
https://ethresear.ch/t/trustless-two-way-bridges-with-side-chains-by-halting/5728

scalability, serializing state
https://twitter.com/peter_szilagyi/status/1273963478752137221
...
1. Scalability may be increased over Ethereum, depending on execution model. An EVM-based optimistic rollup will result in zero scalability improvements. A UTXO-based optimistic rollup will be much more scalable.
1. Additional concerns:
    - No need for hot keys.
    - Private key backup is sufficient to recover funds.
    - No novel cryptography.
    ...
    - Virtually anything can be done in an optimistic rollup, so long as [a compact fraud proof](https://arxiv.org/abs/1809.09044) can be produced.
...
TODO security analysis comparison

TODO scaling, zkps none

TODO summary, when to choose (NFTs)
